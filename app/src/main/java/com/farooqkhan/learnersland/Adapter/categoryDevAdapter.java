...
public class categoryDevAdapter extends RecyclerView.Adapter<categoryDevAdapter.categoryViewHolder> {
    Context context;
    ArrayList<categoryModel> categoryModels;

    public categoryDevAdapter(Context context, ArrayList<categoryModel> categoryModels) {
    ...
    public categoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.sample_video_recyclerview,null);
